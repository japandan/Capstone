...
\chapter{Figures}
![Heat Map Communis Ricinis, Rcom_9 Sample on KEGG](figures/kegg/Rcom_9_M4_AM_R1_7Mar16_Samwise_15-08-55_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}

![Heat Map Communis Ricinis, Rcom_9 Sample on UniProt](figures/uniprot/Rcom_9_M4_AM_R1_7Mar16_Samwise_15-08-55_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}



![Heat Map Communis Ricinis, Rcom_GC4 Sample on KEGG](figures/kegg/Rcom_GCH4_1_2_03Jun16_Samwise_16-03-32_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}

![Heat Map Communis Ricinis, 555510-DeNovo Sample on UniProt](figures/uniprot/555510-DeNovo_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map Communis Ricinis, 555558-DeNovo Sample on UniProt](figures/uniprot/555558-DeNovo_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map Communis Ricinis, Rcom_GCH4_1_2 Sample on UniProt](figures/uniprot/Rcom_GCH4_1_2_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map S. namaycush with P. fragi spoilage, Fish-DeNove Sample on UniProt](figures/uniprot/Fish-DeNove_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map C. clementina Juice-DeNovo Sample on UniProt](figures/uniprot/Juice-DeNovo_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map B. taurus, Milk-DeNovo Sample on UniProt](figures/uniprot/Milk-DeNovo_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
![Heat Map C. virginica, Oyster-DeNovo Sample on UniProt](figures/uniprot/Oyster-DeNovo_org_heatmap_min_o_1_min_p_1.jpeg){width=60%}
