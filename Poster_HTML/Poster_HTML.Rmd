...
```{r parse, cho=FALSE, message=FALSE, warnings=FALSE, out.width="100%", fig.cap = "Flowchart showing in-silico digestion of protein amino acid sequence to determine peptides."}
