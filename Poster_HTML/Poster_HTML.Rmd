...
secondary_colour: "#39994" #Hood Warm Gray 6, RGB 164, 154, 148
...
![UniProt Heat Map R. communis Prep (castor bean)](555510-DeNovo_org_heatmap_min_o_1_min_p_1.png){width=95%}

The MARLOWE score for each test sample is show in Table 2. In the Fish sample,
